...
if (document.getElementsByClassName('demo').length > 0) {
  var i = 0;
  var txt = `cat portofolio.dat
            #######################################################################
            ------------------------Muhammad Haikal--------------------------------
            #######################################################################

            ###descriptions
            Currently work as ETL DevOps Developer and Pentaho Job Migration with Netezza & Greenplum PostgreSQL. I have experience at develop applications using ASP.NET C#, PHP also work one and half years experience at IT Operational such as Network Configuration and Maintenance.
